...
const ICON_MAP = {
  ...
  // Tool type icons
  "tool-system": BoltIcon,
  "tool-webhook": WebhookIcon,
  "tool-client": WrenchIcon,
  "tool-mcp": ServerIcon,
  "tool-integration": BlocksIcon,
};
...
function BoltIcon(props: JSX.HTMLAttributes<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
...
function WebhookIcon(props: JSX.HTMLAttributes<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
...
function WrenchIcon(props: JSX.HTMLAttributes<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
...
function ServerIcon(props: JSX.HTMLAttributes<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
...
function BlocksIcon(props: JSX.HTMLAttributes<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
