    ...
    <ScrollAreaPrimitive.Root className="grow min-h-0" {...props}>
      <ScrollAreaPrimitive.Viewport
        className={cn(
          ...
          "before:bg-[linear-gradient(to_bottom,var(--el-base),transparent)] after:bg-[linear-gradient(to_top,var(--el-base),transparent)]",
          "before:[height:min(40px,var(--scroll-area-overflow-y-start))] after:[height:min(40px,var(--scroll-area-overflow-y-end,40px))]",
