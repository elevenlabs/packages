...
setup:
- pnpm build
- run export AGENT_ID and XI_API_KEY
- run node generate-token.js
- run python -m http.server 8000
- visit localhost:8000 and open test-webrtc-local.html
- enter agent id and livekit token in page, (token was generated by node generate-token.js)
- connect
